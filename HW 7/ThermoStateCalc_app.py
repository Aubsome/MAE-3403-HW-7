#region imports
import sys
from output import Ui__frm_StateCalculator
from pyXSteam.XSteam import XSteam
from PyQt5.QtWidgets import QApplication, QMainWindow, QWidget, QVBoxLayout, QGroupBox, QLabel, QGridLayout, QPushButton, QComboBox, QLineEdit
...
class main_window(QWidget,Ui__frm_StateCalculator):
    ...
    def SetupSlotsAndSignals(self):
        ...
        self._cmb_Property1_4.currentIndexChanged.connect(self.setUnits)
        self._cmb_Property2_4.currentIndexChanged.connect(self.setUnits)
        self._cmb_Property1_3.currentIndexChanged.connect(self.setUnits_1)
        self._cmb_Property2_3.currentIndexChanged.connect(self.setUnits_1)
        self._pb_Calculate_4.clicked.connect(self.calculateProperties)
        self._pb_Calculate_3.clicked.connect(self.calculateProperties_2)
        pass
    ...
    def setUnits(self):
        ...
        SpecifiedProperty1_4 = self._cmb_Property1_4.currentText()
        SpecifiedProperty2_4 = self._cmb_Property2_4.currentText()

        #read numerical values for selected properties
        SP = [float(self._le_Property1_4.text()), float(self._le_Property2_4.text())]



        #set units labels and convert values if needed
        if 'Pressure' in SpecifiedProperty1_4:
            self._lbl_Property1_Units_4.setText(self.p_Units)
        ...
        elif 'Temperature' in SpecifiedProperty1_4:
            self._lbl_Property1_Units_4.setText(self.t_Units)
            if UnitChange:
                SP[0] = UC.F_to_C(SP[0]) if SI else UC.C_to_F(SP[0])
        elif 'Energy' in SpecifiedProperty1_4:
            self._lbl_Property1_Units_4.setText(self.u_Units)
            if UnitChange:
                SP[0] = SP[0] * UC.btuperlb_to_kJperkg if SI else SP[0] * UC.kJperkg_to_btuperlb
        elif 'Enthalpy' in SpecifiedProperty1_4:
            self._lbl_Property1_Units_4.setText(self.h_Units)
            if UnitChange:
                SP[0] = SP[0] * UC.btuperlb_to_kJperkg if SI else SP[0] * UC.kJperkg_to_btuperlb
        elif 'Entropy' in SpecifiedProperty1_4:
            self._lbl_Property1_Units_4.setText(self.s_Units)
            if UnitChange:
                SP[0] = SP[0] * UC.btuperlbF_to_kJperkgC if SI else SP[0] * UC.kJperkgC_to_btuperlbF
        elif 'Volume' in SpecifiedProperty1_4:
            self._lbl_Property1_Units_4.setText(self.v_Units)
            if UnitChange:
                SP[0] = SP[0] * UC.ft3perlb_to_m3perkg if SI else SP[0] * UC.m3perkg_to_ft3perlb
        elif 'Quality' in SpecifiedProperty1_4:
            self._lbl_Property1_Units_4.setText("")

        if 'Pressure' in SpecifiedProperty2_4:
            self._lbl_Property2_Units_4.setText(self.p_Units)
            if UnitChange:
                SP[1] = SP[1] * UC.psi_to_bar if SI else SP[1] * UC.bar_to_psi
        elif 'Temperature' in SpecifiedProperty2_4:
            self._lbl_Property2_Units_4.setText(self.t_Units)
            if UnitChange:
                SP[1] = UC.F_to_C(SP[1]) if SI else UC.C_to_F(SP[1])
        elif 'Energy' in SpecifiedProperty2_4:
            self._lbl_Property2_Units_4.setText(self.u_Units)
            if UnitChange:
                SP[1] = SP[1] * UC.btuperlb_to_kJperkg if SI else SP[1] * UC.kJperkg_to_btuperlb
        elif 'Enthalpy' in SpecifiedProperty2_4:
            self._lbl_Property2_Units_4.setText(self.h_Units)
            if UnitChange:
                SP[1] = SP[1] * UC.btuperlb_to_kJperkg if SI else SP[1] * UC.kJperkg_to_btuperlb
        elif 'Entropy' in SpecifiedProperty2_4:
            self._lbl_Property2_Units_4.setText(self.s_Units)
            if UnitChange:
                SP[1] = SP[1] * UC.btuperlbF_to_kJperkgC if SI else SP[1] * UC.kJperkgC_to_btuperlbF
        elif 'Volume' in SpecifiedProperty2_4:
            self._lbl_Property2_Units_4.setText(self.v_Units)
            if UnitChange:
                SP[1] = SP[1] * UC.ft3perlb_to_m3perkg if SI else SP[1] * UC.m3perkg_to_ft3perlb
        elif 'Quality' in SpecifiedProperty2_4:
            self._lbl_Property2_Units_4.setText("")


        self._le_Property1_4.setText("{:0.3f}".format(SP[0]))
        self._le_Property2_4.setText("{:0.3f}".format(SP[1]))
    ...
    def setUnits_1(self):
        ...
        #read selected Specified Properties from combo boxes
        SpecifiedProperty1_3 = self._cmb_Property1_3.currentText()
        SpecifiedProperty2_3 = self._cmb_Property2_3.currentText()
        #read numerical values for selected properties
        SP = [float(self._le_Property1_4.text()), float(self._le_Property2_4.text()), float(self._le_Property1_3.text()), float(self._le_Property2_3.text())]
        if 'Pressure' in SpecifiedProperty1_3:
            self._lbl_Property1_Units_3.setText(self.p_Units)
            if UnitChange:  # note that I only should convert if needed.  Not if I double click on SI or English
                SP[2] = SP[2] * UC.psi_to_bar if SI else SP[2] * UC.bar_to_psi
        elif 'Temperature' in SpecifiedProperty1_3:
            self._lbl_Property1_Units_3.setText(self.t_Units)
            if UnitChange:
                SP[2] = UC.F_to_C(SP[2]) if SI else UC.C_to_F(SP[2])
        elif 'Energy' in SpecifiedProperty1_3:
            self._lbl_Property1_Units_3.setText(self.u_Units)
            if UnitChange:
                SP[2] = SP[2] * UC.btuperlb_to_kJperkg if SI else SP[2] * UC.kJperkg_to_btuperlb
        elif 'Enthalpy' in SpecifiedProperty1_3:
            self._lbl_Property1_Units_3.setText(self.h_Units)
            if UnitChange:
                SP[2] = SP[2] * UC.btuperlb_to_kJperkg if SI else SP[2] * UC.kJperkg_to_btuperlb
        elif 'Entropy' in SpecifiedProperty1_3:
            self._lbl_Property1_Units_3.setText(self.s_Units)
            if UnitChange:
                SP[2] = SP[2] * UC.btuperlbF_to_kJperkgC if SI else SP[2] * UC.kJperkgC_to_btuperlbF
        elif 'Volume' in SpecifiedProperty1_3:
            self._lbl_Property1_Units_3.setText(self.v_Units)
            if UnitChange:
                SP[2] = SP[2] * UC.ft3perlb_to_m3perkg if SI else SP[2] * UC.m3perkg_to_ft3perlb
        elif 'Quality' in SpecifiedProperty1_3:
            self._lbl_Property1_Units_3.setText("")

        if 'Pressure' in SpecifiedProperty2_3:
            self._lbl_Property2_Units_3.setText(self.p_Units)
            if UnitChange:
                SP[3] = SP[3] * UC.psi_to_bar if SI else SP[3] * UC.bar_to_psi
        elif 'Temperature' in SpecifiedProperty2_3:
            self._lbl_Property2_Units_3.setText(self.t_Units)
            if UnitChange:
                SP[3] = UC.F_to_C(SP[3]) if SI else UC.C_to_F(SP[3])
        elif 'Energy' in SpecifiedProperty2_3:
            self._lbl_Property2_Units_3.setText(self.u_Units)
            if UnitChange:
                SP[3] = SP[3] * UC.btuperlb_to_kJperkg if SI else SP[3] * UC.kJperkg_to_btuperlb
        elif 'Enthalpy' in SpecifiedProperty2_3:
            self._lbl_Property2_Units_3.setText(self.h_Units)
            if UnitChange:
                SP[3] = SP[3] * UC.btuperlb_to_kJperkg if SI else SP[3] * UC.kJperkg_to_btuperlb
        elif 'Entropy' in SpecifiedProperty2_3:
            self._lbl_Property2_Units_3.setText(self.s_Units)
            if UnitChange:
                SP[3] = SP[3] * UC.btuperlbF_to_kJperkgC if SI else SP[3] * UC.kJperkgC_to_btuperlbF
        elif 'Volume' in SpecifiedProperty2_3:
            self._lbl_Property2_Units_3.setText(self.v_Units)
            if UnitChange:
                SP[3] = SP[3] * UC.ft3perlb_to_m3perkg if SI else SP[3] * UC.m3perkg_to_ft3perlb
        elif 'Quality' in SpecifiedProperty2_3:
            self._lbl_Property2_Units_3.setText("")
        self._le_Property1_3.setText("{:0.3f}".format(SP[2]))
        self._le_Property2_3.setText("{:0.3f}".format(SP[3]))
    ...
    def makeLabel_1Phase(self):
        ...
        :return:
        """
        self._lbl_State1.setText("Region = {:}".format(self.region))
    ...
    def makeLabel_1Phase_1(self):
        """
        Given that I have T&P, find the other properties and make the label
        :return:
        """
        self._lbl_State1_2.setText("Region = {:}".format(self.region))
        stProps_1 = "\nPressure = {:0.3f} ({:})".format(self.p, self.p_Units)
        stProps_1 += "\nTemperature = {:0.3f} ({:}) [TSat={:0.3f} ({:})]".format(self.t, self.t_Units, self.tSat,
                                                                               self.t_Units)
        self.u = self.steamTable.u_pt(self.p, self.t)
        ...
        def makeLabel_1Phase(self):
            ...
            stProps += "\nQuality = {:0.3f}".format(self.x)
            self.stProps = stProps
    def makeLabel_1Phase_2(self):
        """
        Given that I have T&P, find the other properties and make the label
        :return:
        """
        self._lbl_State1_3.setText("Region = {:}".format(self.region))
        stProps = "\nPressure = {:0.3f} ({:})".format(self.p, self.p_Units)
        stProps += "\nTemperature = {:0.3f} ({:}) [TSat={:0.3f} ({:})]".format(self.t, self.t_Units, self.tSat,
                                                                               self.t_Units)
        self.u = self.steamTable.u_pt(self.p, self.t)
    ...
    def calculateProperties(self):
        ...
        SP=[self._cmb_Property1_4.currentText()[-2:-1], self._cmb_Property2_4.currentText()[-2:-1], self._cmb_Property1_3.currentText()[-2:-1], self._cmb_Property2_3.currentText()[-2:-1]]
        if SP[0]==SP[1]:
        ...
        #case 1:  pt or tp
            if SP1 == 't':
                f1 = float(self._le_Property1_4.text())
                f2 = float(self._le_Property2_4.text())
                ...
                if self.t < self.tSat or self.t > self.tSat:
                    ...
                    self.stProps += "\nPressure = {:0.3f} ({:})".format(self.p, self.p_Units)
                    self.stProps += "\nTemperature = {:0.3f} ({:}) [TSat={:0.3f} ({:})]".format(
                        self.t, self.t_Units, self.tSat, self.t_Units)
        ...
        #case 11:  tx or xt
                ...
                self.getSatProps_t(self.t)
                self.p=self.pSat
                self.x = float(self._le_Property2_4.text())
                self.x=self.clamp(self.x,0.0,1.0)
                self.makeLabel_2Phase()
            ...
            # case 15:  vx or xv
                ...
                self.p = self.pSat
                self.t = self.tSat
                self.x = self.clamp(float(self._le_Property2_4.text()),0.0,1.0)
                self.makeLabel_2Phase()
    ...
    def calculateProperties_2(self):
        """
        Calculates the thermodynamic state variables based on specified values.
        I have thermodynamic variables:  P, T, v, h, u, s and x (7 things) from which I am choosing two.
        Possible number of permutations:  7!/5! =42.
        ...
        if SP[2] == 'p' or SP[3] == 'p':
            oFlipped = SP[2] != 'p'
            SP2 = SP[2] if oFlipped else SP[3]
            # case 1:  pt or tp
            if SP2 == 't':
                f1 = float(self._le_Property1_3.text())
                f2 = float(self._le_Property2_3.text())
                self.p = f1 if not oFlipped else f2
                self.t = f2 if not oFlipped else f1
                self.getSatProps_p(self.p)
                self.tSat = round(self.tSat, 3)  # I will compare at 3 three decimal places
                ...
                if self.t < self.tSat or self.t > self.tSat:
                    self.region = "sub-cooled  liquid" if self.t < self.tSat else "super-heated vapor"
                    self.makeLabel_1Phase_1()
                else:  # this is ambiguous since at saturated temperature
                    self.region = "two-phase"
                    self.stProps_1 = "Region = {:}".format(self.region)
                    self.stProps_1 += "\nPressure = {:0.3f} ({:})".format(self.p, self.p_Units)
                    self.stProps_1 += "\nTemperature = {:0.3f} ({:}) [TSat={:0.3f} ({:})]".format(
                        self.t, self.t_Units, self.tSat, self.t_Units)
                    self.stProps_1 += "\nInternal Energy = uf={:0.3f}, ug={:0.3f} ({:})".format(self.uf, self.ug,
            ...
            # case 11:  tx or xt
                ...
                self.getSatProps_t(self.t)
                self.p = self.pSat
                self.x = float(self._le_Property2_3.text())
                self.x = self.clamp(self.x, 0.0, 1.0)
                self.makeLabel_2Phase_1()
        elif SP[2] == 'v' or SP[3] == 'v':
            oFlipped = SP[2] != 'v'
            SP2 = SP[2] if oFlipped else SP[3]
            # case 12:  vh or hv
            if SP2 == 'h':
            ...
            # case 15:  vx or xv
                ...
                self.p = self.pSat
                self.t = self.tSat
                self.x = self.clamp(float(self._le_Property2_3.text()), 0.0, 1.0)
                self.makeLabel_2Phase_1()
        elif SP[2] == 'h' or SP[3] == 'h':
            oFlipped = SP[2] != 'h'
            SP2 = SP[2] if oFlipped else SP[3]
            # case 16:  hu or uh
            if SP2 == 'u':
            ...
            if SP2 == 'x':
                ...
                self.x = self.clamp(float(self._le_Property2_3.text()), 0.0, 1.0)
                self.makeLabel_2Phase_1()
        self._lbl_StateProperties_3.setText(self.stProps_1)
